...
class ChatAI {
    ...
    constructor(options) {
        let defaults = {
            ...
            version: '1.0.0',
            show_tokens: true,
            available_models: ['gpt-3.5-turbo', 'gpt-3.5-turbo-0613', 'gpt-3.5-turbo-16k', 'gpt-3.5-turbo-16k-0613']
        };
    ...
    _welcomePageTemplate() {
        return `
            <div class="welcome">
                <h1>SamadAI<span class="ver">${this.options.version}</span></h1>                    
                <p>Built with heart by😊<a href="https://github.com/s-samadmasud" target="_blank">Suhal Samad</a></p>
